                    ...
                    container ('zap') {
                        script {
                            try {
                                ...
                                sh "curl -s \"${ZAP_URL}/JSON/reports/action/generate/?title=ZAP%20Security%20Report&template=risk-confidence-html&reportDir=/zap/reports/&reportFileName=${buildName}\""
